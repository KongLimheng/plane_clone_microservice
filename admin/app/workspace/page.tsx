...
const WorkspaceManagementPage = observer(() => {
  ...
  return (
    <div className="relative container mx-auto size-full p-4 space-y-6 flex flex-col">
              ...
              <div className={`shrink-0 pr-4 ${isSubmitting && "opacity-70"}`}>
                <div className="flex items-center gap-4">
                  <ToggleSwitch
                    ...
                    onChange={() => {
                      if (Boolean(parseInt(disableWorkspaceCreation))) {
          ...
          {workspaceLoader !== "init-loader" ? (
            <>
              <div className="pt-6 flex items-center justify-between gap-2">
                <div className="flex flex-col itece gap-x-2">
              ...
              <div className="flex flex-col gap-4 py-2">
                {workspaceIds.map((workspaceId) => (
                  <WorkspaceListItem workspaceId={workspaceId} key={workspaceId} />
                ))}
              </div>
              {hasNextPage && (
                <div>
