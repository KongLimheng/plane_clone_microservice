...
export const WorkspaceCreateForm = () => {
  ...
  return (
    <div className="space-y-8">
      <div className="grid w-full max-w-4xl grid-cols-1 items-start justify-between gap-x-10 gap-y-6 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-1">
            <Controller
              ...
              rules={{
                ...
                maxLength: { value: 80, message: "Limit your name to 80 characters" },
              }}
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="w-full">
            <Controller
              ...
              rules={{ required: "This is a required filed." }}
              render={({ field: { value, onChange } }) => (
                <CustomSelect
                  value={value}
                  onChange={onChange}
