        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <div className="w-full space-y-1">
              <label htmlFor="first_name" className="text-sm text-onboarding-text-300 font-medium">
            ...
            <div className="w-full space-y-1">
              <label htmlFor="last_name" className="text-sm text-onboarding-text-300 font-medium">
            ...
            <div className="relative">
              ...
              {showPassword.password ? (
                ...
                <button
                  ...
                  tabIndex={-1}
                  onClick={() => handleShowPassword("password")}
                  className="absolute right-3 top-3.5 flex justify-center items-center text-custom-text-400"
                >
