...
import { TIME_ZONES, TTimezone } from "@/constants/timezone";
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="flex w-full flex-col gap-6">
            <div className="relative h-44 w-full">
              ...
              <div className="absolute -bottom-6 left-6 float-start items-end justify-between flex">
                <div className="flex gap-3">
                  <div className="flex size-16 items-center justify-center rounded-lg bg-custom-background-90">
                    <button type="button" onClick={() => setIsImageUploadModalOpen(true)}>
                      {!userAvatar || userAvatar === "" ? (
                        <div className="size-16 rounded-md bg-custom-background-80 p-2">
                ...
                <Controller
                  ...
                  render={({ field: { value, onChange } }) => (
                    <ImagePickerPopover
                      control={control}
                      label="Change cover"
                      onChange={(imgUrl) => onChange(imgUrl)}
                  ...
                  <Controller
                    ...
                    render={({ field: { value, onChange, ref } }) => (
                      <Input
                        ...
                        className={cn("w-full rounded-md", { "border-red-500": errors.first_name })}
                        maxLength={24}
                        autoComplete="on"
                      />
                    )}
