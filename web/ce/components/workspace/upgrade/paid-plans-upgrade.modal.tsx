...
export const PaidPlanUpgradeModal = ({ isOpen, handleClose }: PaidPlanUpgradeModalProps) => (
    ...
    <div className="p-10 max-h-[90vh] overflow-auto">
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 md:col-span-4">
          ...
          {/* Free plan details */}
          <div className="py-4 px-2 border border-custom-border-100 rounded-xl">
                ...
                {FREE_PLAN_UPGRADE_FEATURES.map((feature) => (
                  <li key={feature} className={cn("col-span-12 relative rounded-md p-2 flex")}>
                    <p className="w-full text-sm font-medium leading-5 flex items-center">
                      <CircleX className="size-4 mr-4 text-red-500 flex-shrink-0" />
