...
export const ProjectCard = observer(({ project }: Props) => {
  // states
        ...
        <div className="relative h-[118px] w-full rounded-t">
          ...
          <div className="absolute bottom-4 z-[1] flex h-10 w-full items-center justify-between gap-3 px-4">
            <div className="flex flex-grow items-center gap-2.5 truncate">
              <div className="size-9 flex-shrink-0 grid place-items-center rounded bg-white/10">
            ...
            {!isArchived && (
              <div data-prevent-nprogress className="flex h-full flex-shrink-0 items-center gap-2">
                <button
                  ...
                  className="flex size-6 items-center justify-center rounded bg-white/10"
                >
