      ...
      <Popover.Panel className={"fixed z-10"}>
        {({ close }) => (
          <div
            ...
            style={styles.popper}
            {...attributes.popper}
            className="border border-onboarding-border-300 bg-onboarding-background-100 rounded z-10 py-1 px-2 w-64 break-words flex items-center gap-3 text-left ml-3"
          >
