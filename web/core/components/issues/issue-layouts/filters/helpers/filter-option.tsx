...
export const FilterOption = ({ icon, isChecked, multiple = true, onClick, title, activePulse = false }: Props) => (
  <button
    type="button"
    onClick={onClick}
    className="flex items-center gap-2 rounded p-1.5 hover:bg-custom-background-80"
  >
    <div
