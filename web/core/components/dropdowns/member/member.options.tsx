...
import { Avatar, ComboInput, ComboOptions } from "@plane/ui";
...
export const MemberOptions = observer(
  ({ projectId, referenceElement, placement, isOpen, optionsClassName = "" }: Props) => {
    // states
    ...
    return createPortal(
      <ComboOptions data-prevent-outside-click static>
        <div
          className={cn(
        ...
        >
          <div className="flex items-center gap-1.5 rounded border border-custom-border-100 bg-custom-background-90 px-2">
            <Search className="size-3.5 text-custom-text-400 " strokeWidth={1.5} />
            <ComboInput
              as="input"
              ref={inputRef}
              className={
