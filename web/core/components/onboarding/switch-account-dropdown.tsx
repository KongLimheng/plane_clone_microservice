...
export const SwitchAccountDropDown = observer(({ fullName }: TSwitchAccountDropdownProps) => {
  // states
      ...
      <div className="flex items-center gap-x-2 pr-4 z-10">
        ...
        <Menu as={"div"} className={"relative"}>
          ...
          >
            <Menu.Items
              className={
                "absolute z-10 right-0 rounded-md border-[0.5px] border-custom-border-300 mt-2 bg-custom-background-100 px-2 py-2.5 text-sm min-w-[12rem] shadow-custom-shadow-rg"
              }
            >
              <Menu.Item
                as={"button"}
