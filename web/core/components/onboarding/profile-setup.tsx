...
import { IUser, TOnboardingSteps, TUserProfile } from "@plane/types";
import { Button, Input, setToast, Spinner, TOAST_TYPE } from "@plane/ui";
...
import { PasswordStrengthMeter } from "../account";
import { UserImageUploadModal } from "../core";
...
export const ProfileSetup = observer(({ user, totalSteps, stepChange, finishOnboarding }: Props) => {
  ...
  const handleSubmitProfileSetup = async (formData: TProfileSetupFormValues) => {
    ...
    try {
      ...
      setToast({ type: TOAST_TYPE.SUCCESS, title: "Success", message: "Profile setup completed!" });
  ...
  return (
    <div className="flex h-full w-full">
      <div className="w-full h-full overflow-auto px-6 py-10 sm:px-7 sm:py-14 lg:px-28">
                  ...
                  <div className="space-y-1">
                    ...
                    <Controller
                      ...
                      rules={{
                        ...
                        maxLength: { value: 24, message: "First name must be within 24 characters." },
                      }}
                ...
                <div className="space-y-1">
                  ...
                  <Controller
                    ...
                    render={({ field: { value, onChange } }) => (
                      <div className="flex flex-wrap gap-2 overflow-auto break-all py-2">
                        {USER_ROLE.map((userRole) => (
                          <div
                            key={userRole}
                            className={cn(
                              "shrink-0 border-[0.5px] hover:cursor-pointer hover:bg-onboarding-background-300/30",
