...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    cover_image_asset = models.ForeignKey(
        FileAsset, on_delete=models.SET_NULL, null=True, blank=True, related_name='user_cover_image'
    )
...
class Profile(TimeAuditModel):
    ...
    # address data
    billing_address_country = models.CharField(max_length=255, default="KH")
