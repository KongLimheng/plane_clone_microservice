from plane.db.models import WorkspaceMemberInvite, WorkspaceMember, User, ProjectMemberInvite, ProjectMember
from plane.utils.cache import invalidate_cache_directly


def process_workspace_project_invitations(user: User):
