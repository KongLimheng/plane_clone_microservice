...
class OauthAdapter(Adapter):
    def __init__(self, request, provider,  client_id, scope, redirect_uri, auth_url, token_url, userinfo_url, client_secret=None, code=None, callback=None):
    ...
    def get_user_response(self):
        try:
            ...
            res = requests.get(self.get_user_info_url(), headers=headers)
