...
class InstanceEndpoint(BaseAPIView):
        ...
        (
            ...
            [
                ...
                },
                {
                    ...
                    "default": env("DISABLE_WORKSPACE_CREATION", "0"),
                },
                {
                ...
                },
                {
                    ...
                    "default": env("IS_GITHUB_ENABLED", "0"),
                },
                {
                    "key": "GITHUB_APP_NAME",
                ...
                },
                {
                    ...
                    "default": env("ENABLE_EMAIL_PASSWORD", "1"),
                },
                {
                    "key": "SLACK_CLIENT_ID",
                    "default": env("SLACK_CLIENT_ID", None),
                },
                {
                    "key": "POSTHOG_API_KEY",
                    "default": env("POSTHOG_API_KEY", None),
                },
                {
                    "key": "POSTHOG_HOST",
                    "default": env("POSTHOG_HOST", None),
                },
                {
    ...
    def patch(self, req):
        # Get the instance
        instance = Instance.objects.first()
        serializer = InstanceSerializer(instance, data=req.data, partial=True)
