import { EditorReadOnlyRefApi, IMentionHighlight, TDocumentEventsServer, TExtensions, TFileHandler } from "@/types";
import { HocuspocusProvider } from "@hocuspocus/provider";
import { EditorProps } from "@tiptap/pm/view";
import { MutableRefObject, useEffect, useImperativeHandle, useRef } from "react";
  ...
  const editor = useCustomEditor({
    ...
    extensions: [
      ...CoreReadOnlyEditorExtensions({
        disabledExtensions,
        mentionConfig: { mentionHighlights: mentionHandler.highlights },
        fileHandler,
      }),
      ...extensions,
    ],
